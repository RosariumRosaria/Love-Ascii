...
return {
	...
	rapier = {
		name = "Rapier",
		description = "A duelist's blade. Light to ensure deft hands.",
		color = { STEEL },
		slot = "mainhand",
		chars = { "/" },
		volume = 6,
	...
	maul = {
		name = "Maul",
		description = "A heavy, blunt head on a long haft. Inaccurate, but deadly.",
		color = { STEEL },
		slot = "mainhand",
		chars = { "P" },
		volume = 9,
		modifiers = {
			...
			{ stat = "damage_spread", op = "add", value = 4, context = "melee" },
			{ stat = "accuracy", op = "add", value = -1, context = "melee" },
		},
	},
	dagger = {
	...
	bow = {
		...
		chars = { "D" },
		modifiers = {
			{ stat = "damage", op = "add", value = 3, context = "ranged" },
	...
	cloak = {
		name = "Cloak",
		description = "A dark, well made cloak. Shields one from prying eyes and grasping claws.",
		color = { STEEL },
		slot = "accessory",
		chars = { "A" },
		volume = 9,
		modifiers = {
			{ stat = "evasion", value = 1, op = "add" },
			{ stat = "stealth", value = 1, op = "add" },
		},
	},
	bracers = {
		name = "Bracers",
	...
	leather_armor = {
		name = "Leather Armor",
		description = "Supple boiled leather. Light enough to move in.",
	...
	chainmail = {
		name = "Chainmail",
		description = "Interlocking rings. Deflects light damage, but somewhat bulky.",
		...
		modifiers = {
			...
			{ stat = "stealth", op = "add", value = -3 },
		},
	},
	platemail = {
		name = "Platemail",
		description = "Articulated plate. Little gets through it, and but at a cost to mobility.",
		color = { { 0.72, 0.74, 0.78, 1 } },
		chars = { "A" },
		slot = "armor",
		modifiers = {
			{ stat = "padding", op = "add", value = 3 },
			{ stat = "speed", op = "mul", value = 0.8 },
			{ stat = "stealth", op = "add", value = -5 },
		},
	},
	torch = {
		name = "Torch",
