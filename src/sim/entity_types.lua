...
return {
	...
	chest = {
		...
		loot = {
			...
			drops = {
				{ item = "bandage", weight = 40 },
				{ item = "plank", weight = 20 },
				{ item = "arrow", weight = 12 },
				{ item = "health_potion", weight = 8 },
				{ item = "splint", weight = 6 },
				{ item = "torch", weight = 6 },
				...
				{ item = "bow", weight = 2 },
				{ item = "tunic", weight = 3 },
				{ item = "leather_armor", weight = 3 },
				{ item = "chainmail", weight = 2 },
				{ item = "platemail", weight = 1 },
			},
		},
		inventory = {
			items = {},
	...
	barrel = {
		...
		loot = {
			count = { min = 1, max = 3 },
			drops = {
				{ item = "plank", weight = 32 },
				{ item = "bandage", weight = 24 },
				{ item = "arrow", weight = 8 },
				{ item = "torch", weight = 6 },
				{ item = "health_potion", weight = 4 },
	...
	bookshelf = {
		...
		loot = {
			...
			drops = {
				{ item = "bandage", weight = 24 },
				{ item = "plank", weight = 12 },
				{ item = "health_potion", weight = 8 },
				{ item = "splint", weight = 6 },
				{ item = "strength_potion", weight = 5 },
				{ item = "torch", weight = 4 },
				{ item = "arrow", weight = 2 },
