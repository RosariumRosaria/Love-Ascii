...
function runtime:load()
	...
	local medium_scale = render_cfg.font.medium_scale or (ui_scale * 1.5)
	local big_scale = render_cfg.font.big_scale or (ui_scale * 2)
	local very_big_scale = render_cfg.font.very_big_scale or (ui_scale * 4)
	...
	local medium_size = math.max(1, math.floor(render_cfg.font.base_size * medium_scale + 0.5))
	local big_size = math.max(1, math.floor(render_cfg.font.base_size * big_scale + 0.5))
	local very_big_size = math.max(1, math.floor(render_cfg.font.base_size * very_big_scale + 0.5))
	if render_cfg.font.use_pixel then
		...
		self.medium_font = love.graphics.newFont(font_path, medium_size)
		self.big_font = love.graphics.newFont(font_path, big_size)
		self.very_big_font = love.graphics.newFont(font_path, very_big_size)
		self.font:setFilter("nearest", "nearest")
		self.small_font:setFilter("nearest", "nearest")
		self.terminal_font:setFilter("nearest", "nearest")
		self.medium_font:setFilter("nearest", "nearest")
		self.big_font:setFilter("nearest", "nearest")
		self.very_big_font:setFilter("nearest", "nearest")
	else
		...
		self.medium_font = love.graphics.newFont(medium_size)
		self.big_font = love.graphics.newFont(big_size)
		self.very_big_font = love.graphics.newFont(very_big_size)
	end
	...
	self.medium_tile_size = self.medium_font:getHeight()
	self.big_tile_size = self.big_font:getHeight()
	self.very_big_tile_size = self.very_big_font:getHeight()
end
